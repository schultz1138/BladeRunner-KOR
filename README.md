...
문제 발견 시 Saved Games에 저장된 세이브 파일과 함께 본 깃허브의 issues로 제보해 주시면 큰 도움이 됩니다.

KIA 인터페이스에서 용의자 이름이 영문으로 표시됩니다. 이름에 해당하는 Actors를 수정할 경우,  
용의자 코드가 00-0000 으로 표기되는 버그가 있어, 현재는 영문을 표기하는 방법을 선택하였습니다. 
...
- NSM53 님 (https://nsm53p.tistory.com/)
...
- AI 사용 고지:  
	- 초벌 번역 (영어를 유럽어 자막과 비교 번역)과 코드/문서 정리, 실행 파일의 아이콘 제작에 AI를 사용했습니다.  
